...
@Tag(name = "Tier Upgrade Engine", description = "Tier upgrade evaluation and history endpoints")
public class TierUpgradeEngineController {
    ...
    @Operation(summary = "Evaluate tier upgrade", description = "Evaluate and perform tier upgrade for a customer")
