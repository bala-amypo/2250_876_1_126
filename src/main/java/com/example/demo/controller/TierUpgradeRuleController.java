...
@Tag(name = "Tier Upgrade Rules", description = "Tier upgrade rule management endpoints")
public class TierUpgradeRuleController {
    ...
    @GetMapping("/lookup")
    @Operation(summary = "Lookup rule", description = "Find a rule by from and to tier")
