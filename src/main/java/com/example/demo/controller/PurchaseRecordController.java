...
@Tag(name = "Purchase Records", description = "Purchase record management endpoints")
public class PurchaseRecordController {
    ...
    @PostMapping
    @Operation(summary = "Record purchase", description = "Record a new purchase for a customer")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get purchase by ID", description = "Retrieve a purchase record by ID")
