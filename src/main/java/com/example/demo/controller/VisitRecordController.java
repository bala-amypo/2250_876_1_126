...
@Tag(name = "Visit Records", description = "Visit record management endpoints")
public class VisitRecordController {
    ...
    @PostMapping
    @Operation(summary = "Record visit", description = "Record a new visit for a customer")
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get visit by ID", description = "Retrieve a visit record by ID")
